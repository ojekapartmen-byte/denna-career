...
function VacanciesPage() {
  return (
    <div className="min-h-screen w-full" style={{ backgroundColor: BRAND_CREAM }}>
      {/* Top bar */}
      <header className="w-full px-5 sm:px-8 pt-5 pb-2">
        <Link
          to="/"
          className="inline-flex items-center gap-2 text-base font-semibold rounded-full px-4 py-2 transition-colors hover:bg-white/60"
          style={{ color: BRAND_BLUE }}
      ...
      <main className="w-full px-5 sm:px-8 pb-16 max-w-2xl mx-auto">
        {/* Main header */}
        <h1
          className="text-3xl sm:text-4xl font-bold uppercase tracking-wide text-center mt-6 mb-3"
          style={{ color: BRAND_BLUE }}
        >
          Job Vacancies
        </h1>
